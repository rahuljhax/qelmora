                            ...
                            isAuthenticated ?
                                <>
                                    ...
                                    <button onClick={logout}
                                        className="cursor-pointer px-3.5 py-1.5 rounded-md bg-slate-900 text-slate-200 hover:bg-slate-800 border border-slate-800 transition-colors font-medium"
                                    >
                                        Logout
                                    </button>
                                </> :
